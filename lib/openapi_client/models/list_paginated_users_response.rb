...
module OpenapiClient
  class ListPaginatedUsersResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ListPaginatedUsersResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] _links Value to be assigned
    def _links=(_links)
      if _links.nil?
        fail ArgumentError, '_links cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] created_before Value to be assigned
    def created_before=(created_before)
      if created_before.nil?
        fail ArgumentError, 'created_before cannot be nil'
      end
