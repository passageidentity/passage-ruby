...
require 'openapi_client/models/github_social_connection'
require 'openapi_client/models/google_social_connection'
...
require 'openapi_client/models/user_event_info'
