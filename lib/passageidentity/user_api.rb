    ...
    class UserAPI
        ...
        def get_user(user_id:)
            ...
            begin
                ...
                if e.is_a?Faraday::ResourceNotFound
                    ...
                    raise PassageError, "failed to get Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
                end
            end
        end
        ...
        def activate_user(user_id:)
            ...
            begin
                ...
                if e.is_a?Faraday::ResourceNotFound
                    ...
                    raise PassageError, "failed to activate Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
                end
            end
        end
        ...
        def deactivate_user(user_id:)
            ...
            begin
                ...
                if e.is_a?Faraday::ResourceNotFound
                    ...
                    raise PassageError, "failed to deactivate Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
                end
            end
        end
        ...
        def update_user(user_id:, email: "", phone: "", user_metadata: {})
            ...
            begin
                ...
                if e.is_a?Faraday::ResourceNotFound
                    ...
                    raise PassageError, "failed to update Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
                end
            end
        end
        ...
        def create_user(email: "", phone: "", user_metadata: {})
            ...
            begin
                ...
                raise PassageError, "failed to create Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
            end
        end
        ...
        def delete_user(user_id:)
            ...
            begin
                ...
                if e.is_a?Faraday::ResourceNotFound
                    ...
                    raise PassageError, "failed to delete Passage User. Http Status: #{e.response[:status]}. Response: #{e.response[:body]["error"]}"
                end
            end
        end
    end
