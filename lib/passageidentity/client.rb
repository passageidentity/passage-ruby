...
module Passage
  App = 
    Struct.new :name, :id, :auth_origin, :redirect_url, :login_url, :rsa_public_key, :allowed_identifer, :required_identifier, :require_email_verification, :session_timeout_length, :user_metadata_schema, :layouts, keyword_init: true 
  User =
    Struct.new :id,
               :status,
               :email,
